 ...
 */
export function generateCacheKey(...args: (string | number | object | undefined | null)[]): string {
  return args
    .map(arg => {
...
export class CacheManager {
   ...
   */
  public static getCache<T = any>(name: string, options?: CacheOptions): LocalCache<T> {
  ...
  public static getSemanticScholarCache(): LocalCache {
    return this.getCache("semantic-scholar", { ttl: 12 * 60 * 60 * 1000, maxSize: 100 }); // 12 hours
  }
