...
export class ThemeManager {
  ...
  public static init(win?: Window): void {
    ...
    if (typeof ztoolkit !== "undefined") {
      ztoolkit.log("Paper Copilot: Theme initialized with mode:", this.currentTheme);
    }
  }
  ...
  private static applyTheme(mode: ThemeMode, win?: Window): void {
    ...
    const targetDoc = win?.document || (typeof document !== "undefined" ? document : null);
   ...
   */
  public static onThemeChange(callback: (theme: ThemeMode) => void): () => void {
  ...
  public static attachThemeToggleListener(win: Window): void {
    ...
    if (toggleBtn) {
      toggleBtn.addEventListener("click", () => {
        ...
        toggleBtn.setAttribute("data-tooltip", `Toggle ${actualTheme === "dark" ? "Light" : "Dark"} Mode`);
      });
    }
  }
}
