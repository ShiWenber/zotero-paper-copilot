...
export class OnboardingManager {
  ...
  private static defaultSteps: OnboardingStep[] = [
    {
      ...
      content:
        "Your AI assistant for research papers. Let's take a quick tour to get you started.",
      position: "right",
    },
    {
      id: "select-text",
      ...
      content:
        "Simply select any text in a PDF to get AI explanations, translations, or ask questions about the selected content.",
    ...
    },
    {
      ...
      title: "Quick Actions",
      content:
        "Use the sidebar buttons for quick actions: Summarize papers, translate content, or start a conversation with AI.",
      position: "bottom",
    },
    {
      ...
      content:
        "Press Alt+L to open the sidebar. Use Ctrl+Enter to quickly ask about selected text.",
      position: "top",
    },
    {
      id: "complete",
      ...
      content:
        "Enjoy using Paper Copilot! You can always access help from the sidebar menu or preferences.",
      position: "right",
    },
  ];
  ...
  public static getHelpPanelHTML(): string {
    const topicsHTML = this.helpTopics
      .map(
        (topic) => `
...
export class ErrorFormatter {
  ...
  public static formatError(
    ...
    const suggestions =
      recoverySuggestions || this.getDefaultSuggestions(errorMessage);
  ...
  private static getDefaultSuggestions(
      ...
      suggestions.push(
        {
          ...
          action: "window.PaperCopilot.openSettings()",
        },
    ...
    if (lowerError.includes("pdf") || lowerError.includes("document")) {
      suggestions.push(
        { label: "📄 Reload PDF", action: "window.PaperCopilot.reloadPDF()" },
        {
          ...
          action: "alert('Try selecting text from a different PDF document.')",
        },
      );
    }
    ...
    suggestions.push({
      label: "❓ Get Help",
      action: "window.PaperCopilot.showHelp()",
    });
